...
\centering
\includegraphics[width=\textwidth]{figures_L2/theoryE.png}
\label{fig:theory E}
\end{figure}
...
\caption{noe? everything per spin}
\centering
\includegraphics[width=\textwidth]{figures_L2/theoryM.png}
\label{fig:theory M}
\end{figure}
...
\caption{noe? everything per spin}
\centering
\includegraphics[width=\textwidth]{figures_L2/error_E_MC.png}
\label{fig: error E}
\end{figure}
